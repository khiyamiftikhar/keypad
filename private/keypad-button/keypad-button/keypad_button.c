...
#define TOTAL_BUTTON_OBJECTS        (CONFIG_MATRIX_KEYPAD_MAX_KEYPADS*CONFIG_MATRIX_KEYPAD_MAX_ROWS*CONFIG_MATRIX_KEYPAD_MAX_ROWS)
#define DEBOUNCING_DURATION         (CONFIG_MATRIX_KEYPAD_DEBOUNCE_MS*1000)   //Convert to micro
#define LONG_PRESS_DURATION         (CONFIG_MATRIX_KEYPAD_LONG_PRESS_MS*1000)
#define REPEAT_PRESS_DURATION       (CONFIG_MATRIX_KEYPAD_REPEAT_PRESS_MS*1000)
